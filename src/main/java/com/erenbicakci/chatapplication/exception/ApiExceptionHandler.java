...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ExceptionResponse> chatRoomNotFoundException (Exception e){
        ExceptionResponse exceptionResponse = new ExceptionResponse(LocalDate.now(), e.getMessage(), "ROOM");
        return new ResponseEntity<>(exceptionResponse, HttpStatus.BAD_REQUEST);
    }
